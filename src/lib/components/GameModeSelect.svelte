...
<RadioGroup.Root class="flex flex-col md:flex-row items-center justify-center md:gap-8 gap-4 w-full" bind:value={gameMode}>
  <RadioGroup.Item
    value="budget"
    id="budget"
    class="md:p-6 p-2 rounded-2xl border-2 border-white data-[state=checked]:border-imdb data-[state=checked]:bg-imdb data-[state=checked]:text-black text-white data-[state=checked]:scale-110 duration-150 w-[21rem] hover:border-imdb"
  >
